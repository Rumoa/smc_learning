...
steps = 1000
no_particles = 1000
hamiltonian = model_two_qubits_interact_two_params
K = 10
# true_particles = np.array([2.3, 7.8, 9.4])
true_particles = np.array([1.3, 3.7])
...
alpha_avg = np.mean(estimated_list, axis=0)
alpha_std = np.std(estimated_list, axis = 0)
